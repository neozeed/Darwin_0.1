/*
 * $Header: /CVSRoot/CoreOS/Services/ntp/ntp/libparse/parsestreams.c,v 1.1.1.2 1998/10/30 22:18:22 wsanchez Exp $
 *  
 * $Id: parsestreams.c,v 1.1.1.2 1998/10/30 22:18:22 wsanchez Exp $
 *
...
#ifndef lint
static char rcsid[] = "$Id: parsestreams.c,v 1.1.1.2 1998/10/30 22:18:22 wsanchez Exp $";
#endif
...
#ifdef PPS_SYNC
	(char *)"PARSEPPS     ",		/* name this baby - keep room for revision number */
#else
	(char *)"PARSE        ",		/* name this baby - keep room for revision number */
#endif
};
	...
	)
{
	...
	switch (fc)
	{
	  ...
	  if (!Strncmp(fm->f_name, mname, FMNAMESZ))
		...
		{
			static char revision[] = "$Revision: 1.1.1.2 $";
			char *s, *S, *t;
 ...
 * History:
 *
 * $Log: parsestreams.c,v $
 * Revision 1.1.1.2  1998/10/30 22:18:22  wsanchez
