/*
 * $Header: /CVSRoot/CoreOS/Services/ntp/ntp/libparse/clk_meinberg.c,v 1.1.1.2 1998/10/30 22:18:19 wsanchez Exp $
 *  
 * $Id: clk_meinberg.c,v 1.1.1.2 1998/10/30 22:18:19 wsanchez Exp $
 *
	  ...
	  )
{
  ...
  if ( msg_buf->phase == MBG_NONE )
	...
	case SOH:
	  ...
	  parseio->parse_dtime.parse_stime = *tstamp; /* collect timestamp */
	  return PARSE_INP_SKIP;       /* continue gobble data */
  ...
  if ((msg_buf->phase == MBG_STRING) && (parseio->parse_index < parseio->parse_dsize))
 ...
 * History:
 *
 * $Log: clk_meinberg.c,v $
 * Revision 1.1.1.2  1998/10/30 22:18:19  wsanchez
