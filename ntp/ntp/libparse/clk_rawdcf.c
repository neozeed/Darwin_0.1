/*
 * $Header: /CVSRoot/CoreOS/Services/ntp/ntp/libparse/clk_rawdcf.c,v 1.1.1.2 1998/10/30 22:18:20 wsanchez Exp $
 *  
 * $Id: clk_rawdcf.c,v 1.1.1.2 1998/10/30 22:18:20 wsanchez Exp $
 *
