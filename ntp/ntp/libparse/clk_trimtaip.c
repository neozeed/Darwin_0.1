/*
 * $Header: /CVSRoot/CoreOS/Services/ntp/ntp/libparse/clk_trimtaip.c,v 1.1.1.2 1998/10/30 22:18:21 wsanchez Exp $
 *
 * $Id: clk_trimtaip.c,v 1.1.1.2 1998/10/30 22:18:21 wsanchez Exp $
 *
