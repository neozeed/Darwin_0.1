/*
 * $Header: /CVSRoot/CoreOS/Services/ntp/ntp/libparse/parse_conf.c,v 1.1.1.2 1998/10/30 22:18:18 wsanchez Exp $
 *  
 * $Id: parse_conf.c,v 1.1.1.2 1998/10/30 22:18:18 wsanchez Exp $
 *
