/*
 * $Header: /CVSRoot/CoreOS/Services/ntp/ntp/libparse/data_mbg.c,v 1.1.1.1 1998/10/30 22:18:21 wsanchez Exp $
 *
...
void
get_mbg_ascii_msg(bufpp, ascii_msgp)
     unsigned char **bufpp;
...
void
get_mbg_antinfo(buffpp, antinfop)
     unsigned char **buffpp;
     ANT_INFO *antinfop;
{
...
static void
mbg_time_status_str(buffpp, status)
     unsigned char **buffpp;
     unsigned int status;
{
  static struct state
...
void
get_mbg_portparam(buffpp, portparamp)
     unsigned char **buffpp;
...
/*
 * $Log: data_mbg.c,v $
 * Revision 1.1.1.1  1998/10/30 22:18:21  wsanchez
