/*
 * $Header: /CVSRoot/CoreOS/Services/ntp/ntp/libparse/clk_schmid.c,v 1.1.1.2 1998/10/30 22:18:19 wsanchez Exp $
 *  
 * $Id: clk_schmid.c,v 1.1.1.2 1998/10/30 22:18:19 wsanchez Exp $
 *
