 ...
 *
 *	$Header: /CVSRoot/CoreOS/Commands/NeXT/bootstrap_cmds/migcom.tproj/routine.h,v 1.1.1.1.8.2 1999/03/16 16:12:00 wsanchez Exp $	
 *
 * HISTORY
...
#if	NeXT
#define akeSendTime	(10)	/* pointed at by rtSendTime */
#endif	NeXT
...
#if	NeXT
    u_int rtMaxRequestSize;	/* maximal size of a legal request msg */
    u_int rtMaxReplySize;	/* maximal size of a legal reply msg */
#endif	NeXT
...
#if	NeXT
    argument_t *rtSendTime;	/* if non-NULL, will use SEND_TIMEOUT */
#endif	NeXT
