/* $Header: /CVSRoot/CoreOS/Commands/Other/tcsh/tcsh/mi.termios.c,v 1.1.1.1 1997/08/29 17:57:49 wsanchez Exp $ */
/* termios.c - fake termios interface using sgtty interface 
 * 	       by Magnus Doell and Bruce Evans.
 *
 */
#include "sh.h"
RCSID("$Id: mi.termios.c,v 1.1.1.1 1997/08/29 17:57:49 wsanchez Exp $")
