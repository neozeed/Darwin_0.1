/* $Header: /CVSRoot/CoreOS/Commands/Other/tcsh/tcsh/vms.termcap.c,v 1.1.1.2 1998/11/05 01:13:19 wsanchez Exp $ */
/*
 ...
 */
#include "sh.h"
RCSID("$Id: vms.termcap.c,v 1.1.1.2 1998/11/05 01:13:19 wsanchez Exp $")
