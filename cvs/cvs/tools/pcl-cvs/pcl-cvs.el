...
;;;
;;;#ident "@(#)cvs/contrib/pcl-cvs:$Name: cvs-14 $:$Id: pcl-cvs.el,v 1.2 1998/04/07 07:13:49 wsanchez Exp $"
;;;
;;; pcl-cvs.el -- A Front-end to CVS 1.3 or later.
;;; Release 1.05-CVS-$Name: cvs-14 $.
...
(defconst pcl-cvs-version "1.05-CVS-$Name: cvs-14 $"
...
(defconst cvs-startup-message
  (if cvs-inhibit-copyright-message
      "PCL-CVS release 1.05-CVS-$Name: cvs-14 $"
    "PCL-CVS release 1.05 from CVS release $Name: cvs-14 $.
...
This description is updated for release 1.05-CVS-$Name: cvs-14 $ of pcl-cvs.
...
ERR-BUF should be 'STDOUT or 'STDERR."
  ...
  (let* ((stdout (save-excursion (set-buffer stdout-buffer) (buffer-string)))
    ...
    (insert "CVS Version: "
	    "@(#)cvs/contrib/pcl-cvs:$Name: cvs-14 $:$Id: pcl-cvs.el,v 1.2 1998/04/07 07:13:49 wsanchez Exp $\n\n")
