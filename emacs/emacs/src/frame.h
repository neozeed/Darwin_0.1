...
enum output_method
{ output_termcap, output_x_window, output_msdos_raw, output_w32, output_ns };
...
struct frame
{
  ...
  union output_data { struct x_output *x; struct w32_output *w32; struct ns_output *ns; int nothing; } output_data;
