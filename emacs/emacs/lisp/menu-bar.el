...
;; make a copy of the existing menu-bar for ns-menu-bar.el
(if (and (fboundp 'ns-create-frame)
         (lookup-key global-map [menu-bar]))
    (defvar ns-original-menu-bar
      (copy-alist (cdr (assq 'menu-bar global-map)))))
