...
(defvar command-line-ns-option-alist
  '(("-NXAutoLaunch" 1 ns-ignore-1-arg)
    ("-ns" 0 ns-ignore-0-arg)
    ("-NXHost" 1 ns-ignore-1-arg)
    ("-MachLaunch" 1 ns-ignore-1-arg)
    ("-NXOpen" 1 ns-handle-nxopen)
    ("-NXOpenTemp" 1 ns-handle-nxopentemp)
...
(defun command-line ()
  ...
  (if (or (not (memq window-system '(x w32 ns)))
