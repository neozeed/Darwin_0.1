...
static struct ldaperror ldap_errlist[] = {
	...
	LDAP_REFERRAL,			"Referral encountered",
	LDAP_ADMINLIMIT_EXCEEDED,	"Administration limit exceeded",
	LDAP_UNAVAILABLE_CRITICAL_EXTENSION,	"Critical extension unavailable",
	...
	LDAP_NOT_SUPPORTED,		"Operation not supported",
