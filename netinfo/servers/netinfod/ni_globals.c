...
const char SHADOW_NAME_PREFIX[] = "_shadow_";
const char SECURE_NAME_PREFIX[] = "_secure_";
const char SHADOW_DIR_KEY[] = "_shadow";
const char SECURE_DIR_KEY[] = "_secure";
const char VALUE_SHADOW[] = "*";
...
int sending_all = 0;
mutex_t readall_mutex;
mutex_t lockup_mutex;
